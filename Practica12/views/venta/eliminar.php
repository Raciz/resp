        ...
        <div class="modal-content">
            ...
            <form id="formDelV" role="form" method="post" autocomplete="off" action="index.php?section=venta&action=eliminar&shop=<?php echo $_GET["shop"]; ?>">
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger alert-dismissible ocultar" id="errorDelV">
                    ...
                    <div class="form-group">
                        <input type="hidden" id="delV" name="del">
                        <label>Ingrese Su Contraseña Para Confirmar</label>
                        <input type="password" class="form-control" id="passV" name="contraseña" placeholder="Ingrese Contraseña" required>
                    </div>
                </div>
...
<script>
    ...
    var errorDelV = document.getElementById("errorDelV");
    ...
    function ocultar()
    {
        ...
        errorDelV.setAttribute("class","alert alert-danger alert-dismissible ocultar");
    }
    ...
    (function()
     {
        ...
        function validar(e)
        {
            ...
            var pass = document.getElementById("passV").value;
            ...
            if('<?php echo $_SESSION["password"]?>' != pass)
            {
                ...
                errorDelV.setAttribute("class","alert alert-danger alert-dismissible");
            }   
        }
