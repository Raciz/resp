...
<!--Modal para la confirmacion del editado de un producto-->
<div class="modal modal-info fade" id="edit-producto" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--formulario para pedir al usuario su contraseña para confirmar el editado de un producto-->
            <form id="formEdit" role="form" method="post" autocomplete="off" action="index.php?section=inventario&action=listado">
                ...
                <div class="modal-footer">
                    <!--Botones para continuar o cancelar la edicion del producto-->
...
<script>
    ...
    function idEdit(edit)
    {
        ...
        //le asignamos a value del que es el id del producto a editar 
...
<div class="modal modal-info fade in" id="modal-info" style="display: block; padding-right: 15px;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="post" autocomplete="off" action="index.php?section=inventario&action=editar">
                <div class="modal-body">
                    <?php
                    //creamos un objeto de mvcInventario
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php?section=inventario&action=listado"><button type="button" class="btn btn-outline pull-left">Cancelar</button></a>
