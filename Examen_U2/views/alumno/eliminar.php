...
{
    //se crea un onjeto de mvcAlumno
    $eliminar = new mvcAlumno();

    //se manda a llamar el controller para eliminar un Alumno
    $eliminar -> eliminarAlumnoController();
}
?>

<!--Modal para la confirmacion del borrado de un alumno-->
<div class="modal modal-info fade" id="del-alumno" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--formulario para pedir al usuario su contraseña para confirmar el borrado del alumno-->
            <form id="formDelP" role="form" method="post" autocomplete="off" action="index.php?section=alumno&action=eliminar">
                ...
                <div class="modal-footer">
                    <!--Botones para continuar o cancelar con la eliminacion del alumno-->
