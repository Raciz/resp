...
//verificamos si se debe mandar a llamar el controller para eliminar un pago del sistema
if(isset($_GET["action"]) && $_GET["action"]=="eliminar")
{
    //se crea un onjeto de mvcPago
    $eliminar = new mvcPago();

    //se manda a llamar el controller para eliminar un pago
    $eliminar -> eliminarPagoController();
}
?>

<!--Modal para la confirmacion del borrado de un pago-->
<div class="modal modal-info fade" id="Del-pago" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formDelP" role="form" method="post" autocomplete="off" action="index.php?section=pago&action=eliminar">
                ...
                <div class="modal-footer">
                    <!--Botones para continuar o cancelar con la eliminacion del pago-->
...
<script>
    ...
    function idDel(del)
    {
        ...
        //le asignamos a value del que es el id del pago a eliminar 
