...
<?php
//verificamos si se requiere desplegar el modal para modificar la informacion de un grupo
if (isset($_POST["edit"]))
{
?>

<!--modal para editar la informacion del grupo-->
<div class="modal modal-info fade in" id="modal-info" style="display: block; padding-right: 15px;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--formulario para editar la informacion de un grupo-->
            <form role="form" method="post" autocomplete="off" action="index.php?section=grupo&action=editar">
                <div class="modal-body">
                    <?php
                    //creamos un objeto de mvcGrupo
                    $editar = new mvcGrupo();
                    ...
                    $editar -> editarGrupoController();
                    ?>               
                </div>
                <div class="modal-footer">
                    <!--Botones para guardar o cancelar con la modificacion de la informacion del grupo-->
                    <a href="index.php?section=grupo&action=listado"><button type="button" class="btn btn-outline pull-left">Cancelar</button></a>
